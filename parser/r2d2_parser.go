...
func r2d2ParserInit() {
	...
	staticData.SymbolicNames = []string{
		...
		"DEFAULT", "INCREMENT", "DECREMENT", "PLUS_ASSIGN", "MINUS_ASSIGN",
		...
		"COMMA", "DOT", "COLON", "SEMI", "AT", "JS", "ARROW", "TYPE", "STRING_LITERAL",
	...
	staticData.serializedATN = []int32{
		...
		72, 74, 76, 78, 80, 82, 84, 0, 8, 1, 0, 11, 13, 1, 0, 26, 27, 2, 0, 28,
		32, 44, 44, 3, 0, 26, 27, 40, 40, 47, 47, 1, 0, 41, 43, 1, 0, 39, 40, 2,
		0, 33, 36, 45, 46, 1, 0, 37, 38, 609, 0, 89, 1, 0, 0, 0, 2, 109, 1, 0,
		0, 0, 4, 111, 1, 0, 0, 0, 6, 118, 1, 0, 0, 0, 8, 122, 1, 0, 0, 0, 10, 138,
		1, 0, 0, 0, 12, 156, 1, 0, 0, 0, 14, 175, 1, 0, 0, 0, 16, 182, 1, 0, 0,
		0, 18, 192, 1, 0, 0, 0, 20, 200, 1, 0, 0, 0, 22, 212, 1, 0, 0, 0, 24, 219,
		1, 0, 0, 0, 26, 226, 1, 0, 0, 0, 28, 228, 1, 0, 0, 0, 30, 241, 1, 0, 0,
		0, 32, 255, 1, 0, 0, 0, 34, 280, 1, 0, 0, 0, 36, 282, 1, 0, 0, 0, 38, 285,
		1, 0, 0, 0, 40, 325, 1, 0, 0, 0, 42, 335, 1, 0, 0, 0, 44, 357, 1, 0, 0,
		0, 46, 359, 1, 0, 0, 0, 48, 365, 1, 0, 0, 0, 50, 375, 1, 0, 0, 0, 52, 385,
		1, 0, 0, 0, 54, 390, 1, 0, 0, 0, 56, 392, 1, 0, 0, 0, 58, 395, 1, 0, 0,
		0, 60, 398, 1, 0, 0, 0, 62, 414, 1, 0, 0, 0, 64, 438, 1, 0, 0, 0, 66, 458,
		1, 0, 0, 0, 68, 460, 1, 0, 0, 0, 70, 476, 1, 0, 0, 0, 72, 478, 1, 0, 0,
		0, 74, 497, 1, 0, 0, 0, 76, 499, 1, 0, 0, 0, 78, 508, 1, 0, 0, 0, 80, 537,
		1, 0, 0, 0, 82, 544, 1, 0, 0, 0, 84, 546, 1, 0, 0, 0, 86, 88, 3, 6, 3,
		0, 87, 86, 1, 0, 0, 0, 88, 91, 1, 0, 0, 0, 89, 87, 1, 0, 0, 0, 89, 90,
		1, 0, 0, 0, 90, 95, 1, 0, 0, 0, 91, 89, 1, 0, 0, 0, 92, 94, 3, 8, 4, 0,
		93, 92, 1, 0, 0, 0, 94, 97, 1, 0, 0, 0, 95, 93, 1, 0, 0, 0, 95, 96, 1,
		0, 0, 0, 96, 101, 1, 0, 0, 0, 97, 95, 1, 0, 0, 0, 98, 100, 3, 2, 1, 0,
		99, 98, 1, 0, 0, 0, 100, 103, 1, 0, 0, 0, 101, 99, 1, 0, 0, 0, 101, 102,
		1, 0, 0, 0, 102, 104, 1, 0, 0, 0, 103, 101, 1, 0, 0, 0, 104, 105, 5, 0,
		0, 1, 105, 1, 1, 0, 0, 0, 106, 110, 3, 10, 5, 0, 107, 110, 3, 4, 2, 0,
		108, 110, 3, 30, 15, 0, 109, 106, 1, 0, 0, 0, 109, 107, 1, 0, 0, 0, 109,
		108, 1, 0, 0, 0, 110, 3, 1, 0, 0, 0, 111, 112, 5, 13, 0, 0, 112, 113, 5,
		67, 0, 0, 113, 114, 3, 22, 11, 0, 114, 115, 5, 44, 0, 0, 115, 116, 3, 62,
		31, 0, 116, 117, 5, 57, 0, 0, 117, 5, 1, 0, 0, 0, 118, 119, 5, 2, 0, 0,
		119, 120, 5, 62, 0, 0, 120, 121, 5, 57, 0, 0, 121, 7, 1, 0, 0, 0, 122,
		123, 5, 5, 0, 0, 123, 126, 5, 67, 0, 0, 124, 125, 5, 7, 0, 0, 125, 127,
		5, 67, 0, 0, 126, 124, 1, 0, 0, 0, 126, 127, 1, 0, 0, 0, 127, 128, 1, 0,
		0, 0, 128, 133, 5, 50, 0, 0, 129, 132, 3, 12, 6, 0, 130, 132, 3, 32, 16,
		0, 131, 129, 1, 0, 0, 0, 131, 130, 1, 0, 0, 0, 132, 135, 1, 0, 0, 0, 133,
		131, 1, 0, 0, 0, 133, 134, 1, 0, 0, 0, 134, 136, 1, 0, 0, 0, 135, 133,
		1, 0, 0, 0, 136, 137, 5, 51, 0, 0, 137, 9, 1, 0, 0, 0, 138, 139, 5, 6,
		0, 0, 139, 142, 5, 67, 0, 0, 140, 141, 5, 7, 0, 0, 141, 143, 5, 67, 0,
		0, 142, 140, 1, 0, 0, 0, 142, 143, 1, 0, 0, 0, 143, 144, 1, 0, 0, 0, 144,
		150, 5, 50, 0, 0, 145, 149, 3, 12, 6, 0, 146, 149, 3, 30, 15, 0, 147, 149,
		3, 32, 16, 0, 148, 145, 1, 0, 0, 0, 148, 146, 1, 0, 0, 0, 148, 147, 1,
		0, 0, 0, 149, 152, 1, 0, 0, 0, 150, 148, 1, 0, 0, 0, 150, 151, 1, 0, 0,
		0, 151, 153, 1, 0, 0, 0, 152, 150, 1, 0, 0, 0, 153, 154, 5, 51, 0, 0, 154,
		11, 1, 0, 0, 0, 155, 157, 5, 8, 0, 0, 156, 155, 1, 0, 0, 0, 156, 157, 1,
		0, 0, 0, 157, 159, 1, 0, 0, 0, 158, 160, 5, 10, 0, 0, 159, 158, 1, 0, 0,
		0, 159, 160, 1, 0, 0, 0, 160, 161, 1, 0, 0, 0, 161, 162, 5, 9, 0, 0, 162,
		163, 5, 67, 0, 0, 163, 165, 5, 48, 0, 0, 164, 166, 3, 18, 9, 0, 165, 164,
		1, 0, 0, 0, 165, 166, 1, 0, 0, 0, 166, 167, 1, 0, 0, 0, 167, 169, 5, 49,
		0, 0, 168, 170, 3, 22, 11, 0, 169, 168, 1, 0, 0, 0, 169, 170, 1, 0, 0,
		0, 170, 173, 1, 0, 0, 0, 171, 174, 3, 76, 38, 0, 172, 174, 5, 57, 0, 0,
		173, 171, 1, 0, 0, 0, 173, 172, 1, 0, 0, 0, 174, 13, 1, 0, 0, 0, 175, 176,
		3, 16, 8, 0, 176, 177, 5, 57, 0, 0, 177, 15, 1, 0, 0, 0, 178, 179, 5, 67,
		0, 0, 179, 181, 5, 55, 0, 0, 180, 178, 1, 0, 0, 0, 181, 184, 1, 0, 0, 0,
		182, 180, 1, 0, 0, 0, 182, 183, 1, 0, 0, 0, 183, 185, 1, 0, 0, 0, 184,
		182, 1, 0, 0, 0, 185, 186, 5, 67, 0, 0, 186, 188, 5, 48, 0, 0, 187, 189,
		...
		19, 1, 0, 0, 0, 199, 197, 1, 0, 0, 0, 200, 202, 5, 67, 0, 0, 201, 203,
		...
		222, 1, 0, 0, 0, 222, 25, 1, 0, 0, 0, 223, 227, 5, 67, 0, 0, 224, 227,
		5, 61, 0, 0, 225, 227, 3, 28, 14, 0, 226, 223, 1, 0, 0, 0, 226, 224, 1,
		0, 0, 0, 226, 225, 1, 0, 0, 0, 227, 27, 1, 0, 0, 0, 228, 229, 5, 67, 0,
		0, 229, 230, 5, 45, 0, 0, 230, 235, 3, 22, 11, 0, 231, 232, 5, 54, 0, 0,
		232, 234, 3, 22, 11, 0, 233, 231, 1, 0, 0, 0, 234, 237, 1, 0, 0, 0, 235,
		233, 1, 0, 0, 0, 235, 236, 1, 0, 0, 0, 236, 238, 1, 0, 0, 0, 237, 235,
		1, 0, 0, 0, 238, 239, 5, 46, 0, 0, 239, 29, 1, 0, 0, 0, 240, 242, 5, 8,
		0, 0, 241, 240, 1, 0, 0, 0, 241, 242, 1, 0, 0, 0, 242, 243, 1, 0, 0, 0,
		243, 244, 5, 1, 0, 0, 244, 245, 5, 67, 0, 0, 245, 249, 5, 50, 0, 0, 246,
		...
		258, 7, 0, 0, 0, 258, 260, 5, 67, 0, 0, 259, 261, 3, 22, 11, 0, 260, 259,
		1, 0, 0, 0, 260, 261, 1, 0, 0, 0, 261, 264, 1, 0, 0, 0, 262, 263, 5, 44,
		...
		0, 405, 415, 3, 74, 37, 0, 406, 415, 5, 67, 0, 0, 407, 415, 3, 16, 8, 0,
		...
		55, 0, 0, 450, 459, 5, 67, 0, 0, 451, 459, 5, 26, 0, 0, 452, 459, 5, 27,
		...
		69, 1, 0, 0, 0, 467, 465, 1, 0, 0, 0, 468, 477, 5, 67, 0, 0, 469, 477,
		...
		5, 66, 0, 0, 493, 498, 5, 62, 0, 0, 494, 498, 5, 63, 0, 0, 495, 498, 5,
...
const (
	...
	R2D2ParserINCREMENT      = 26
	R2D2ParserDECREMENT      = 27
	R2D2ParserPLUS_ASSIGN    = 28
	R2D2ParserMINUS_ASSIGN   = 29
	R2D2ParserMULT_ASSIGN    = 30
	R2D2ParserDIV_ASSIGN     = 31
	R2D2ParserMOD_ASSIGN     = 32
	R2D2ParserEQ             = 33
	R2D2ParserNEQ            = 34
	R2D2ParserLEQ            = 35
	R2D2ParserGEQ            = 36
...
func (p *R2D2Parser) FunctionDeclaration() (localctx IFunctionDeclarationContext) {
	...
	if (int64((_la-52)) & ^0x3f) == 0 && ((int64(1)<<(_la-52))&33281) != 0 {
		{
			p.SetState(168)
			p.TypeExpression()
		}
...
func (p *R2D2Parser) FunctionCall() (localctx IFunctionCallContext) {
	...
	if (int64((_la-26)) & ^0x3f) == 0 && ((int64(1)<<(_la-26))&4329400451075) != 0 {
		{
			p.SetState(187)
			p.ArgumentList()
		}
...
func (p *R2D2Parser) AssignmentOperator() (localctx IAssignmentOperatorContext) {
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&17600507543552) != 0) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
...
func (p *R2D2Parser) expression(_p int) (localctx IExpressionContext) {
	...
	case 5:
		...
		_prevctx = localctx
		{
			...
			if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&141837201309696) != 0) {
				p.GetErrorHandler().RecoverInline(p)
			} else {
				p.GetErrorHandler().ReportMatch(p)
				p.Consume()
		...
		if _alt == 1 {
			...
			case 3:
				...
				}
				{
					...
					if !((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&105681965285376) != 0) {
						p.GetErrorHandler().RecoverInline(p)
					} else {
						p.GetErrorHandler().ReportMatch(p)
						p.Consume()
...
func (p *R2D2Parser) MemberExpression() (localctx IMemberExpressionContext) {
	...
	for (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&40813871824371712) != 0 {
		{
			p.SetState(439)
			p.MemberPart()
		}
...
func (p *R2D2Parser) Block() (localctx IBlockContext) {
	...
	for (int64((_la-8)) & ^0x3f) == 0 && ((int64(1)<<(_la-8))&1136052251753508729) != 0 {
		{
			p.SetState(500)
			p.Statement()
		}
